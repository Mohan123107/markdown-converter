...
| 7 | Regression across all existing flows supported in Beacon >> Amit (Starting marketing hooks to all social media) | amit : in progress , |  |
| 8 | XDEX integration to Beacon >> Abdul/Syed |  |  |
